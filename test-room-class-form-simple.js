/**
 * Simple Test Script for Room Class Form Submission
 * 
 * This script tests the room class form submission using built-in Node.js modules
 * without requiring external dependencies like node-fetch.
 */
...
function testRoomClassFormSubmission() {
