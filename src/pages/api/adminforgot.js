...
const handler = async (req, res) => {
  //check if the admin exists in the database or not
  if (req.body.sendMail == true) {
    ...
    try{
      ...
      const info = await transporter.sendMail({
        ...
        To reset your password for hoteldcrescent.com, please follow the link below:
