...
export default function Home({catroom,slider,gallery}) {

  return (
   <div className=' bg-[conic-gradient(at_bottom_right,_var(--tw-gradient-stops))] from-slate-900 via-purple-900 to-slate-900'>
     <Head>
      <title>Hotel DCrescent - Your Ultimate Hotel Booking Destination</title>
      <meta property="og:title" content="Hotel DCrescent - Your Ultimate Hotel Booking Destination" />
      <meta name="description" content='Find your dream hotel and enjoy a delightful getaway with top-notch accommodation. Book now for a comfortable and memorable stay!'/>
      <link rel='icon' href="/favicon.ico"/>
      <meta name="keywords" content="hotel booking, accommodation, online reservations, comfortable accommodations, vacation getaway, top-rated hotel, delightful stay, convenient hospitality, memorable retreat" />
      
      <meta property="og:description" content="Find your dream hotel and enjoy a delightful getaway with top-notch accommodation. Book now for a comfortable and memorable stay!"/>
...
let slider=await Slider.find();
  return {
      props: {catroom:JSON.parse(JSON.stringify(catroom)),slider:JSON.parse(JSON.stringify(slider)),gallery: JSON.parse(JSON.stringify(gallery))},
  };
}